...
export class SourceError extends Error {
  ...
  private static readonly codeMappings = {
    ...
    'file.notFound': (filePath: string) =>
      `Locale file not found: "${filePath}"`,
    ...
    'file.nonCanonicalName': (filePath: string, locale: Locale) =>
      `Locale file name "${filePath}" is not in canonical form. Expected "${locale}.json"`,
