 ...
 * нечёткого сравнения строк, таких как Левенштейн, Дамерау-Левенштейн, Jaro-Winkler и других.
 *
 ...
 * @example
 * ```ts
 * const result: EditDistanceResult = damerauLevenshtein("команда", "команда");
 * log(result.steps);      // 0
...
export interface EditDistanceResult {
   ...
   * ```
   *
   * @defaultValue Диапазон: от 0 (полное совпадение) до 1 (максимальное различие)
   *
   **/
   ...
   * ```
   * @defaultValue Диапазон: от 0 (максимальное различие) до 1 (полное совпадение)
   *
   **/
